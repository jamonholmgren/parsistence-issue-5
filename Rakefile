...
Motion::Project::App.setup do |app|
  ...
  app.name = 'rp-parsistence-issue-5'
  app.identifier = 'com.your_domain_here.rp-parsistence-issue-5'
  ...
  app.development do
    ...
    app.provisioning_profile = "signing/rp-parsistence-issue-5.mobileprovision"
  end
